...
func Test_GetBranches_Success(t *testing.T) {
	expected := []Branch{
		Branch{1324, "new-build-page", "https://semaphoreapp.com/api/v1/projects/:hash_id/1324/status?auth_token=:auth_token"},
		Branch{1120, "development", "https://semaphoreapp.com/api/v1/projects/:hash_id/1120/status?auth_token=:auth_token"},
		Branch{987, "branches_api", "https://semaphoreapp.com/api/v1/projects/:hash_id/987/status?auth_token=:auth_token"},
	}
